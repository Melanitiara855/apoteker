...
@section('title', 'Report Generate Laporan')
@section('content_header')
<h1 class="m-0 text-dark">&nbsp; Report Generate Laporan</h1>
@stop
@section('content')
<div class="container">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h4>Data Reservasi</h4> <a href="{{url('download-generate_laporan-pdf')}}" target="_blank">
                    <button class="btn btn-peach"><i class="fa fa-file "></i> &nbsp; Buka PDF</button>
                </a>
                </div>
                <div class="card-body">
                    <form method="get" action="{{ route('generate_laporan') }}" class="form-inline">
...
table-stripped" id="example3">
    ...
    <script type="text/javascript" src="https://cdn.datatables.net/buttons/2.0.0/js/buttons.print.min.js"></script>
        ...
        $(document).ready(function() {
            $('table:not(#generate_laporan)').DataTable();

            $('#generate_laporan').DataTable({
                dom: 'Bfrtip',
                buttons: [
                    'pdfHtml5',
                    'print'
