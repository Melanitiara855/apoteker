                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            placeholder="Nama Distributor" name="nama distributor" value="{{$distributor->nama_distributor ?? old('nama_distributor')}}">
                        ...
                        <div class="form-group">
                            ...
                            placeholder="Alamat" name="alamat" value="{{$distributor->alamat ?? old('alamat')}}">
                        ...
                        <div class="form-group">
                            ...
                            placeholder="Notelepon" name="notelepon" value="{{$distributor->notelepon ?? old('notelepon')}}">
