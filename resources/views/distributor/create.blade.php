...
placeholder="Nama" name="nama_distributor" value="{{old('nama_distributor')}}">
@error('Nama Distributor') <span class="text-danger">{{$message}}</span> @enderror
                </div>
                <div class="form-group">
                       <label for="exampleInputalamat">Alamat Distributor</label>
                        <input type="text" class="form-control
@error('alamat') is-invalid @enderror" id="exampleInputalamat"
placeholder="Alamat" name="alamat" value="{{old('alamat')}}">
@error('Alamat Distributor') <span class="text-danger">{{$message}}</span> @enderror
                </div>
                <div class="form-group">
                       <label for="exampleInputnotelepon">No telepon</label>
                        <input type="text" class="form-control
@error('notelepon') is-invalid @enderror" id="exampleInputnotelepon"
placeholder="Notelepon" name="notelepon" value="{{old('notelepon')}}">
