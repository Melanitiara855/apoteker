                    ...
                    <label for="nonota_beli">No Nota beli</label>
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('nonota_beli') is-invalid @enderror"
                                ...
                                value="{{  old('nonota_beli') }}" aria-label="No Nota Beli" aria-describedby="cari" readonly>
...
@error('harga_beli') is-invalid @enderror" id="harga_beli" placeholder="Masukkan Harga Beli " name="harga_beli"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('nama_obat') is-invalid @enderror" 
                                ...
                                value="{{ old('nama_obat')}}" aria-label="nama_obat" ariadescribedby="cari" 
                                readonly>
                            <button class="btn btn-warning" type="button" data-bs-toggle="modal" id="cari" 
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('detail_pembelian.index') }}"><button type="submit" class="btn btn-danger">Batal
                                    </button></a>
                        </div>
                    </div>
                </div>
